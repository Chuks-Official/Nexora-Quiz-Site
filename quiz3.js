const questions = [
  ...
  { question: " What is the symbol for oxygen?", options: ["O", "Ox", "O2", "Oz", "On"], answer: "O" },
  { question: " What is the chemical formula for water?", options: ["H2O", "CO2", "O2", "NaCl", "H2"], answer: "H2O" },
  { question: " What is the pH of a neutral solution?", options: ["1", "7", "10", "14", "0"], answer: "7" },
  { question: " Common salt is also known as?", options: ["Sodium Chloride", "Potassium", "Calcium", "Magnesium", "Sulphate"], answer: "Sodium Chloride" },
  { question: " What type of change is rusting of iron?", options: ["Physical", "Chemical", "Reversible", "Neutral", "Temporary"], answer: "Chemical" },
  { question: " Which gas is used in soda drinks?", options: ["Oxygen", "Carbon Dioxide", "Hydrogen", "Nitrogen", "Helium"], answer: "Carbon Dioxide" },
  { question: " What is the smallest unit of an element?", options: ["Atom", "Molecule", "Ion", "Cell", "Electron"], answer: "Atom" },
  { question: " What do carnivores eat?", options: ["Meat", "Plants", "Fruits", "Insects", "Grass"], answer: "Meat" },
  { question: " Which one is a JavaScript data type?", options: ["Class", "Integer", "String", "Boolean", "Double"], answer: "Boolean" },
  { question: " Which is an example of an operating system?", options: ["Microsoft Word", "Google", "Windows", "Printer", "Excel"], answer: "Windows" },
  { question: " Who discovered gravity?", options: ["Albert Einstein", "Galileo", "Newton", "Darwin", "Faraday"], answer: "Newton" },
  { question: " What is the chemical symbol for water?", options: ["H2", "O2", "CO2", "H2O", "HO"], answer: "H2O" },
  { question: " What is the sum of angles in a triangle?", options: ["90°", "180°", "270°", "360°", "100°"], answer: "180°" },
  { question: " Identify the adjective in this sentence: 'She wore a beautiful dress.'", options: ["She", "Wore", "Beautiful", "Dress", "A"], answer: "Beautiful" },
  { question: " What is the boiling point of water in Celsius?", options: ["0°C", "50°C", "100°C", "150°C", "200°C"], answer: "100°C" },
  { question: " Water boils at what temperature?", options: ["90°C", "100°C", "80°C", "120°C"], answer: "100°C" },
  { question: " What is the capital of Nigeria?", options: ["Lagos", "Abuja", "Kano", "Enugu"], answer: "Abuja" },
  { question: "The formula for water is?", options: ["H2O", "CO2", "O2", "NaCl"], answer: "H2O" },
  { question: "4. 7 x 8 = ?", options: ["56", "48", "64", "49"], answer: "56" },
  { question: "Which is the largest planet in our solar system?", options: ["Earth", "Mars", "Jupiter", "Saturn"], correctAnswer: "Jupiter" },
  { question: "Who wrote 'To Kill a Mockingbird'?", options: ["Harper Lee", "George Orwell", "J.K. Rowling", "F. Scott Fitzgerald"], correctAnswer: "Harper Lee" },
  { question: "What is the largest ocean on Earth?", options: ["Atlantic", "Indian", "Arctic", "Pacific"], correctAnswer: "Pacific" },
  { question: "Which country is known as the Land of the Rising Sun?", options: ["China", "Japan", "India", "South Korea"], correctAnswer: "Japan" },
  { question: "What is the tallest mountain in the world?", options: ["K2", "Mount Everest", "Kangchenjunga", "Mount Kilimanjaro"], correctAnswer: "Mount Everest" },
  { question: "Who invented the telephone?", options: ["Alexander Graham Bell", "Nikola Tesla", "Thomas Edison", "Albert Einstein"], correctAnswer: "Alexander Graham Bell" }
];
...
function startTimer() {
  timerInterval = setInterval(() => {
    ...
    if (timeLeft === 30) alert("⚠️ 30 seconds left!");
    if (timeLeft <= 0) {
...
nextBtn.addEventListener("click", () => {
  ...
  const correctAnswer = questions[currentQuestion].answer || questions[currentQuestion].correctAnswer;
